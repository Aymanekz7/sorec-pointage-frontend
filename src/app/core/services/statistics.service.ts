...
export class StatisticsService {
  ...
  private presenceRows(): PresenceLikeRow[] {
    return [
      { matricule: 'AG001', fullName: 'Ahmed Alami', department: 'Direction IT', site: 'Zenith', status: 'Present' },
      { matricule: 'AG007', fullName: 'Nadia Fassi', department: 'Direction IT', site: 'Zenith', status: 'Deplacement', reason: 'Mission externe' },
      { matricule: 'AG018', fullName: 'Samira El Idrissi', department: 'Ressources humaines', site: 'Hors Zenith', status: 'Autres', reason: 'Maternite' },
      { matricule: 'AG024', fullName: 'Karim Bennis', department: 'Operations', site: 'Zenith', status: 'Present' },
      { matricule: 'AG031', fullName: 'Loubna Haddad', department: 'Finance', site: 'Zenith', status: 'Autres', reason: 'Sortie avant l heure' },
      { matricule: 'AG036', fullName: 'Yassine Tahiri', department: 'Marketing', site: 'Hors Zenith', status: 'Deplacement', reason: 'Visite client' }
    ];
  }

  private absenceRows(): PresenceLikeRow[] {
    return [
      { matricule: 'AG004', fullName: 'Maha Boudhime', department: 'Operations', site: '-', status: 'Absent' },
      { matricule: 'AG009', fullName: 'Laila Haddad', department: 'Marketing', site: '-', status: 'Absent' },
      { matricule: 'AG014', fullName: 'Omar Naciri', department: 'Direction IT', site: '-', status: 'Absent' },
      { matricule: 'AG019', fullName: 'Nour Eddine Farah', department: 'Finance', site: '-', status: 'Absent' },
      { matricule: 'AG021', fullName: 'Sara Amrani', department: 'Ressources humaines', site: '-', status: 'Absent' }
    ];
  }
